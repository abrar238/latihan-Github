<div class="wrapper">
<nav id="sidebar">
  <ul class="list-unstyled componet bg-dark">
    <li>
    ...
    <li>
      <a href="#member" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link bg-dark text-white">Member</a>
        <ul class="collapse list-unstyled" id="member">
          <li>
            <a href="?hal=kontak" class="nav-link bg-dark text-white">Detail</a>
          </li>
          <li>
            <a href="?hal=register" class="nav-link bg-dark text-white">Register</a>
          </li>
          <li>
            <a href="?hal=edit" class="nav-link bg-dark text-white">Edit Member</a>
          </li>
        </ul>
    </li>
    <li>
    ...
    <li>
      <a href="?hal=upload" class="nav-link bg-dark text-white">Upload Pdf</a>
    </li>
    <li>
